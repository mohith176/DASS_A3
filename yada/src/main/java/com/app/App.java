...
//         System.out.println("\nBasal Metabolic Rate (BMR): " + Math.round(bmr) + " calories");
...
//         // Show daily calorie log if available
//         List<LogEntry> todaysEntries = dietLog.getEntriesForDate(currentUser.getUserName(), LocalDate.now());
//         if (!todaysEntries.isEmpty()) {
//             int todaysCalories = dietLog.getTotalCaloriesForDate(currentUser.getUserName(), LocalDate.now());
//             System.out.println("\nYour calorie intake for today: " + todaysCalories + " calories");
//             int remaining = Math.round((float)tdee) - todaysCalories;
//             System.out.println("Remaining calories for today: " + remaining + " calories");
//         }
//     }
